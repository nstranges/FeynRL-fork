...
```bash
pip install pydantic==2.12.5 pyyaml==6.0.3 huggingface_hub==0.36.0 transformers==4.57.6 deepspeed==0.18.6 datasets==4.5.0 vllm==0.15.1 mlflow==3.8.1 ray==2.53.0
```
